...
function (_, event, ...)
    ...
    if event == "GROUP_ROSTER_UPDATE" or event == "READY_CHECK" or event == "PLAYER_ENTERING_WORLD" or event == aura_env.customEventName then
