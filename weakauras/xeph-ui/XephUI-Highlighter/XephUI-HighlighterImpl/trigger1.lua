...
--- @param event "COMBAT_LOG_EVENT_UNFILTERED" | "STATUS" | "OPTIONS" | "UNIT_SPELLCAST_SUCCEEDED" | "XEPHUI_Highlighter" | "PLAYER_REGEN_ENABLED" | "ACTIVE_PLAYER_SPECIALIZATION_CHANGED"
--- @return boolean
