-- CLEU:SPELL_MISSED:SPELL_PERIODIC_MISSED:SPELL_AURA_REMOVED:SPELL_AURA_APPLIED:SPELL_DAMAGE:SPELL_HEAL:SPELL_PERIODIC_DAMAGE:SPELL_PERIODIC_HEAL:SPELL_AURA_APPLIED_DOSE:SPELL_AURA_REMOVED_DOSE:SPELL_SUMMON, UNIT_SPELLCAST_SUCCEEDED:player, XEPHUI_Highlighter, PLAYER_REGEN_ENABLED, ACTIVE_PLAYER_SPECIALIZATION_CHANGED, TRAIT_CONFIG_UPDATED
...
--- @param event "COMBAT_LOG_EVENT_UNFILTERED" | "STATUS" | "OPTIONS" | "UNIT_SPELLCAST_SUCCEEDED" | "XEPHUI_Highlighter" | "PLAYER_REGEN_ENABLED" | "ACTIVE_PLAYER_SPECIALIZATION_CHANGED" | "TRAIT_CONFIG_UPDATED"
--- @return boolean
